...
const fetchHAKTokenContract = (signerOrProvider) =>
  new ethers.Contract(HAKTokenAddress, HAKTokenABI, signerOrProvider);
...
export const ERC20ICONProvider = ({ children }) => {
  ...
  const HAKToken = "ICO Name: HAKToken";
  ...
  const checkIfWalletConnected = async () => {
    ...
    const contract = fetchHAKTokenContract(signer);
